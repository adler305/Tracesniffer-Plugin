...
#define MAX_NUMBER_OF_OBJECTS 16 /**< Defines the maximum amount of different objects per array, for example the amount of tasks or queues*/
#define MAX_LENGTH_OF_OBJECTNAME 16 /**< Defines the maximum length of an objectname, like the task name*/

#define SIZE_OF_STREAM_FIFO 1500 /**< Defines the size of the streamFIFO in Payload3-blocks, depending on the timespan in which the Tracer can't send payloads */
#define SIZE_OF_RECEIVE_FIFO 30 /**< Defines the size of the receiveFIFO,in Bytes*/
#define SIZE_OF_ERROR_FIFO 100 /**< Defines the size of the errorFIFO in Payload3-blocks */
...
#define SEND_WITHOUT_SNIFF_TASK 0 // Is generally less RT-Save due to uncontrollable uart interrupts and filter-dependent runtimes
