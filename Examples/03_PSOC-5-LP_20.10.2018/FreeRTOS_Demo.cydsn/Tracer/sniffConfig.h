...
#define MAX_NUMBER_OF_OBJECTS 20 /**< Defines the maximum amount of different objects per array, for example the amount of tasks or queues*/
#define MAX_LENGTH_OF_OBJECTNAME 12 /**< Defines the maximum length of an objectname, like the task name*/
...
#define STACK_SIZE_OF_SNIFF_TASK 100 /**< Defines the stack size of the sniff Task, shouldn't be changed normally*/
...
#define SEND_WITHOUT_SNIFF_TASK 0 
