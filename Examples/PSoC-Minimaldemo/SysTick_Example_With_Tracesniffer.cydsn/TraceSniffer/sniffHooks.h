...
//
#define traceCUSTOM_MARKER_1() {packPayload0(ID_CUSTOM_MARKER_1);}/**< Custom Marker for use everywhere, for example in an interrupt.*/

#define traceCUSTOM_MARKER_2() {packPayload0(ID_CUSTOM_MARKER_2);}/**< Custom Marker for use everywhere, for example in an interrupt.*/

#define traceCUSTOM_MARKER_3(data1,data2){packPayload2(ID_CUSTOM_MARKER_3,data1,data2);}/**< Custom Marker for use everywhere, for example in an interrupt.*/
