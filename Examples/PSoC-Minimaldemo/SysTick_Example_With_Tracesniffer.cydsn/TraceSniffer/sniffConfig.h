...
#define SIZE_OF_STREAM_FIFO 2000 /**< Defines the size of the streamFIFO in Payload3-blocks (9 Byte), depending on the timespan in which the Tracer can't send payloads */
...
#define SEND_WITHOUT_SNIFF_TASK 1 /**< If enabled, the data gets send directly and isn't buffered and send over the sniffTask, which costs less memory but is also less realtime-save*/
